...
inflate_image()
{
	...
	echo "Inflating image file $dev to size ${size_gb}GiB"
...
partition_image()
{
	...
	if [ ! -z ${DOMA_PRESENT} ]; then
		...
		# As result we have partition dedicated for Android. And this partition contains
		# few partitions inside. These 'internal' partitions are Android's native partitions.
